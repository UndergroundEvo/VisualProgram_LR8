...
namespace DiagramEditor.Models
{
    ...
    public class MeasuredText
    {
        ...
        static readonly Graphics graph = Graphics.FromHwndInternal(IntPtr.Zero);
        static MeasuredText()
        {
            List<Font> arr = new();
        ...
        {
            var m = new MeasuredText("Некоторый текст");
            m.Print();
